...
options_ = [];
M_.fname = 'SimpleModel22';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('SimpleModel22.log');
M_.exo_names = 'e1';
M_.exo_names_tex = 'e1';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('SimpleModel22_static');
erase_compiled_function('SimpleModel22_dynamic');
...
save('SimpleModel22_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('SimpleModel22_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('SimpleModel22_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('SimpleModel22_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('SimpleModel22_results.mat', 'estimation_info', '-append');
end
