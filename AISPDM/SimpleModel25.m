...
options_ = [];
M_.fname = 'SimpleModel25';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('SimpleModel25.log');
M_.exo_names = 'e1';
M_.exo_names_tex = 'e1';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('SimpleModel25_static');
erase_compiled_function('SimpleModel25_dynamic');
...
save('SimpleModel25_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('SimpleModel25_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('SimpleModel25_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('SimpleModel25_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('SimpleModel25_results.mat', 'estimation_info', '-append');
end
